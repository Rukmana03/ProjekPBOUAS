...
public class FormBarang extends JFrame {
    ...
    void loadData() {
        try {
            Connection cn = new ConnectionDB().getConnect();
    ...
    void ubahData(Barang B, String kodeBarang) {
        try {
            Connection cn = new ConnectionDB().getConnect();
            Statement st = cn.createStatement();
            String sql = "UPDATE tbl_barang SET kode_barang='" + B.getKodeBarang() + "', nama_barang='" + B.getNamaBarang() + "', harga_barang=" + B.getHargaBarang() + ", stok_barang=" + B.getStokBarang() + " WHERE kode_barang='" + kodeBarang + "'";
            int result = st.executeUpdate(sql);
            cn.close();
    ...
    private void btAddAksi(ActionEvent evt) {
        ...
        B.setHargaBarang(Integer.parseInt(txHargaBarang.getText()));
        B.setStokBarang(Integer.parseInt(txStokBarang.getText()));
        simpanData(B);
    }
